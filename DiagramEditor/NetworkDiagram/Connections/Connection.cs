...
namespace KRLab.DiagramEditor.NetworkDiagram.Connections
{
	public abstract class Connection : DiagramElement
	{
		...
		protected internal Relationship Relationship
		{
		...
		public override void Draw(IGraphics g, bool onScreen, Style style)
		{
            ...
            if(Relationship.SupportsEndStartRole)
            {
        ...
        protected virtual void DrawStartRole(IGraphics g, Style style)
        {
        }

        protected virtual void DrawEndRole(IGraphics g, Style style)
        {
        }

        protected virtual void DrawStartMultiplicity(IGraphics g, Style style)
        {

        }
        protected virtual void DrawEndMultiplicity(IGraphics g, Style style)
        {
