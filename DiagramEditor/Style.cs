...
namespace KRLab.DiagramEditor
{
	...
	public sealed class Style : IDisposable
	{
		...
		static string settingsDir = Path.Combine(
			Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "KRLab");
		...
		// node fields
		int nodeBorderWidth = 1;
		int nodeRoundingSize = 0;
		bool isNodeBorderDashed = false;
		Color nodeBackgroundColor = Color.White;
		Color nodeBorderColor = Color.Black;
		Color nodeHeaderColor = Color.White;
		GradientStyle nodeGradientHeaderStyle = GradientStyle.None;
		...
		public Color TypeBackgroundColor
		{
			get
			{
				Color color = nodeBackgroundColor;
		...
		public bool? IsBorderDashed
		{
			get
			{
				bool dashed = isNodeBorderDashed;
			...
			set
			{
				if (value.HasValue)
				{
					isNodeBorderDashed = value.Value;
		...
		public GradientStyle? HeaderGradientStyle
		{
			get
			{
				GradientStyle value = nodeGradientHeaderStyle;
			...
			set
			{
				if (value.HasValue)
				{
					nodeGradientHeaderStyle = value.Value;
        ...
        [DisplayName("Background Color"), Category("Node")]
		[Description("The background color for the node type.")]
		[DefaultValue(typeof(Color), "White")]
        public Color NodeBackgroundColor
		{
			get { return nodeBackgroundColor; }
			set { nodeBackgroundColor = value; }
		}

        [DisplayName("Border Color"), Category("Node")]
		[Description("The border color for the node type.")]
		[DefaultValue(typeof(Color), "Black")]
		...
		[DisplayName("Border Width"), Category("Node")]
        ...
        [DisplayName("Dashed Border"), Category("Node")]
		[Description("Whether the border for the node type will be dashed.")]
		[DefaultValue(false)]
		public bool IsNodeBorderDashed
		{
			get { return isNodeBorderDashed; }
			set { isNodeBorderDashed = value; }
		}

        [DisplayName("Header Color"), Category("Node")]
		[Description("The background color of the header compartment for the node type.")]
		[DefaultValue(typeof(Color), "White")]
		public Color NodeHeaderColor
		{
			get { return nodeHeaderColor; }
			set { nodeHeaderColor = value; }
		}

        [DisplayName("Rounding Size"), Category("Node")]
		[Description("The rounding size of the corners for the node type.")]
		[DefaultValue(0)]
		public int ClassRoundingSize
		{
			get
			{
				return nodeRoundingSize;
			}
			set
			{
				if (value < 0)
					...
					nodeRoundingSize = value;
			}
		}

        [DisplayName("Header Gradient Style"), Category("Node")]
		[Description("The direction of the gradient header color in node types.")]
		[DefaultValue(GradientStyle.None)]
		public GradientStyle NodeGradientHeaderStyle
		{
			get { return nodeGradientHeaderStyle; }
			set { nodeGradientHeaderStyle = value; }
		}
