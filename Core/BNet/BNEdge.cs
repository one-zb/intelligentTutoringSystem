...
namespace KRLab.BNet
{
    public class BNEdge
    {
        ...
        public BNNode NodeA { get; set; }
        public BNNode NodeB { get; set; }
        ...
        public BNEdge normalizeIM(string influenced)
        {
        ...
        public BNEdge addGeneralProbability(string influencerState, double[] prob, double avgStateDuration)
        {
        ...
        public BNEdge addCIM(string influencerState, double[][] cim)
        {
            //if (!NodeA.States.Exists(x => x == influencerState))
        ...
        public BNEdge makeVertSymmetric(string influencerState)
        {
            //if (!NodeA.States.Exists(x => x == influencerState))
            //    throw new Exception("you can't add a CIM to a state that does not exist. (Bayes Edge -> addCIM)");
