...
namespace Symbolism
{
    ...
    public class Equation : MathObject
    {
        ...
        public void MultiplyBothSideBy(MathObject item)
        {
            this.a *= item;
            this.b *= item;
        }

        public void DividedBothSideBy(MathObject item)
        {
            this.a /= item;
            this.b /= item;
        }
        public void AddToBothSides(MathObject item)
        {
            this.a += item;
            this.b += item;
        }
        public void SubstractBothSides(MathObject item)
        {
            this.a -= item;
            this.b -= item;
        }
        ...
        public static MathObject MultiplyBothSideBy(MathObject equ,MathObject item)
        {
            if (equ is Equation)
            {
                Equation e = (Equation)equ;
                return new Equation(e.a * item, e.b * item, e.Operator);
            }
            else
                return null;
        }

        public static MathObject DividedBothSideBy(MathObject equ,MathObject item)
        {
            if (equ is Equation)
            {
                Equation e = (Equation)equ;
        ...
        public static MathObject AddToBothSides(MathObject equ,MathObject item)
        {
            if (equ is Equation)
            {
                Equation e = (Equation)equ;
        ...
        public static MathObject SubStractBothSides(MathObject equ,MathObject item)
        {
            if (equ is Equation)
            {
                Equation e = (Equation)equ;
    ...
    public class Function : MathObject
    {
        ...
        public List<MathObject> ArgsList => args.ToList();
